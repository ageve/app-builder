...
async function buildPipeline({
  ...
  await pipelineRun(createHugoAivPipelines({ config, pipelines, args }));
}

export function createHugoAivPipelines({
  config,
  pipelines,
  args,
  workspace,
